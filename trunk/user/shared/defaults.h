...
#define DEF_LAN_DHCP_END	"192.168.10.180"
#define DEF_LAN_MASK		"255.255.255.0"

#define DEF_WLAN_2G_CC		"CN"
#define DEF_WLAN_5G_CC		"US"
#define DEF_WLAN_2G_SSID	BOARD_NAME "_%s"
#define DEF_WLAN_5G_SSID	BOARD_NAME "_5G_%s"
#define DEF_WLAN_2G_GSSID	BOARD_NAME "_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_NAME "_GUEST_5G_%s"
